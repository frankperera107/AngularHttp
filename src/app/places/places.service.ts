...
import { catchError, map, tap, throwError,pipe } from 'rxjs';
...
export class PlacesService {
  ...
  loadUserPlaces() {
    return this.fetchPlaces('http://localhost:3000/user-places','Something went wrong fetching your favourite places. Please try again later.')
      .pipe(tap({
